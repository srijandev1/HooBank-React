...
const Footer = () => (
  <section className={` ${styles.flexCenter} ${styles.paddingX} flex-col pb-10`}>
    ...
    <div className="w-full flex justify-between items-center md:flex-row flex-col pt-6 border-t-[0.1px] border-t-[#3f3r45]">
